...
/***************************************************************************
 Device supports two channel selection mechanisms.
Dynamic - through energy scan
Static - fixed channel (currently channel no 11 is used)

Uncomment below given statement if static selection is to be used
****************************************************************************/
